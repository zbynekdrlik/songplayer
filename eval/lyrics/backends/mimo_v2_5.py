#!/usr/bin/env python3
"""mimo_v2_5.py — Xiaomi MiMo-V2.5 audio-LLM via OpenRouter.

Audio-LLM transcription: receives the dereverbed vocal WAV + an
instruction to transcribe with per-line start/stop timing, returns
plain text in `[mm:ss.mmm --> mm:ss.mmm] line` format which the
wrapper parses back into the standard eval backend JSON shape.

OpenRouter slug as of 2026-05-19: `xiaomi/mimo-v2.5-20260422`.

Usage:
    python eval/lyrics/backends/mimo_v2_5.py \\
...
BACKEND_ID = "mimo-v2-5"
BACKEND_REVISION = 1
MODEL_SLUG = "xiaomi/mimo-v2.5-20260422"

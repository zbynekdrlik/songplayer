...
//! the pinned dub voice, and the pure `dub_chain_state` derivation. (The per-video
//! dub-mix ratio was removed in #184 round G — the mixer is now ONE global console.)

...
"#
        ...
        // win-resolume that completions succeed with it (#145). Older 6.x builds
        // simply ignore the absence of the block, so this config text is
        // forward- and backward-compatible across the proxy upgrade.

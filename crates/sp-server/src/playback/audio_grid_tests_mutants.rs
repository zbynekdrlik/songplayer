...
//! `buffer_ms`. Each test pins an EXACT observed value at a precise input so a
//! single operator / whole-body mutation flips it. `super::*` resolves to the
//! `audio_grid` module under test.
